...
Version  : 5.2.1
Release  : 32
URL      : https://github.com/gramps-project/gramps/archive/v5.2.1/gramps-5.2.1.tar.gz
Source0  : https://github.com/gramps-project/gramps/archive/v5.2.1/gramps-5.2.1.tar.gz
...
%prep
%setup -q -n gramps-5.2.1
cd %{_builddir}/gramps-5.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711386868
