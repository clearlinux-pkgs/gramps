...
Version  : 5.1.6
Release  : 30
URL      : https://github.com/gramps-project/gramps/archive/v5.1.6/gramps-5.1.6.tar.gz
Source0  : https://github.com/gramps-project/gramps/archive/v5.1.6/gramps-5.1.6.tar.gz
...
%prep
%setup -q -n gramps-5.1.6
cd %{_builddir}/gramps-5.1.6
pushd ..
cp -a gramps-5.1.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697579795
