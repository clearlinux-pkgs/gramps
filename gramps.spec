...
%prep
%setup -q -n gramps-5.1.2
cd %{_builddir}/gramps-5.1.2
...
cp %{_builddir}/gramps-5.1.2/COPYING %{buildroot}/usr/share/package-licenses/gramps/ae6bd9ea92f856d6c79bff9e349ef6f17eea0426
cp %{_builddir}/gramps-5.1.2/debian/copyright %{buildroot}/usr/share/package-licenses/gramps/27607b90a2bf19b0f5705e92a5533cb62bacf5bd
cp %{_builddir}/gramps-5.1.2/help/COPYING-DOCS %{buildroot}/usr/share/package-licenses/gramps/d4e55a4ce45bed3cec6bbe27f09e20473e7b108f
