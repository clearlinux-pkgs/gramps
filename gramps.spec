...
Version  : 5.1.1
Release  : 4
URL      : https://github.com/gramps-project/gramps/archive/v5.1.1/gramps-5.1.1.tar.gz
Source0  : https://github.com/gramps-project/gramps/archive/v5.1.1/gramps-5.1.1.tar.gz
...
%prep
%setup -q -n gramps-5.1.1
cd %{_builddir}/gramps-5.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574441663
...
cp %{_builddir}/gramps-5.1.1/COPYING %{buildroot}/usr/share/package-licenses/gramps/ae6bd9ea92f856d6c79bff9e349ef6f17eea0426
cp %{_builddir}/gramps-5.1.1/debian/copyright %{buildroot}/usr/share/package-licenses/gramps/27607b90a2bf19b0f5705e92a5533cb62bacf5bd
cp %{_builddir}/gramps-5.1.1/help/COPYING-DOCS %{buildroot}/usr/share/package-licenses/gramps/d4e55a4ce45bed3cec6bbe27f09e20473e7b108f
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/gramps/27607b90a2bf19b0f5705e92a5533cb62bacf5bd
