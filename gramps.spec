...
Version  : 5.2.2
Release  : 33
URL      : https://github.com/gramps-project/gramps/archive/v5.2.2/gramps-5.2.2.tar.gz
Source0  : https://github.com/gramps-project/gramps/archive/v5.2.2/gramps-5.2.2.tar.gz
...
%prep
%setup -q -n gramps-5.2.2
cd %{_builddir}/gramps-5.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712446812
