...
Version  : 5.1.5
Release  : 27
URL      : https://github.com/gramps-project/gramps/archive/v5.1.5/gramps-5.1.5.tar.gz
Source0  : https://github.com/gramps-project/gramps/archive/v5.1.5/gramps-5.1.5.tar.gz
...
%prep
%setup -q -n gramps-5.1.5
cd %{_builddir}/gramps-5.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644447633
...
cp %{_builddir}/gramps-5.1.5/COPYING %{buildroot}/usr/share/package-licenses/gramps/ae6bd9ea92f856d6c79bff9e349ef6f17eea0426
cp %{_builddir}/gramps-5.1.5/help/COPYING-DOCS %{buildroot}/usr/share/package-licenses/gramps/d4e55a4ce45bed3cec6bbe27f09e20473e7b108f
