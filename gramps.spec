...
Version  : 6.0.1
Release  : 38
URL      : https://github.com/gramps-project/gramps/archive/v6.0.1/gramps-6.0.1.tar.gz
Source0  : https://github.com/gramps-project/gramps/archive/v6.0.1/gramps-6.0.1.tar.gz
...
%prep
%setup -q -n gramps-6.0.1
cd %{_builddir}/gramps-6.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745247461
...
/usr/share/gramps/images/hicolor/scalable/actions/format-text-subscript-symbolic.svg
/usr/share/gramps/images/hicolor/scalable/actions/format-text-superscript-symbolic.svg
