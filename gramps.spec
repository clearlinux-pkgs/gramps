...
Version  : 5.2.4
Release  : 36
URL      : https://github.com/gramps-project/gramps/archive/v5.2.4/gramps-5.2.4.tar.gz
Source0  : https://github.com/gramps-project/gramps/archive/v5.2.4/gramps-5.2.4.tar.gz
...
%prep
%setup -q -n gramps-5.2.4
cd %{_builddir}/gramps-5.2.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736781552
