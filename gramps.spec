...
Version  : 6.0.0
Release  : 37
URL      : https://github.com/gramps-project/gramps/archive/v6.0.0/gramps-6.0.0.tar.gz
Source0  : https://github.com/gramps-project/gramps/archive/v6.0.0/gramps-6.0.0.tar.gz
...
%prep
%setup -q -n gramps-6.0.0
cd %{_builddir}/gramps-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742429081
